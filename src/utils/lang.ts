...
const GEORGIAN_DICTIONARY: Record<string, string> = {
  ...
  "Save": "შენახვა",
  "Save and Order": "შენახვა და შეკვეთა",
  "Add and Order": "დამატება და შეკვეთა",
  "Save and Reminder": "შენახვა და შეხსენება",
  "Add and Reminder": "დამატება და შეხსენება",
  ...
  "vada": "ვადა",
  "Vada": "ვადა",
  "overdue_threshold_days": "ვადა",
  "Understood": "გასაგებია",
  "Deletion Blocked": "წაშლა შეზღუდულია",
  ...
  "Supplier Save Error": "მომწოდებლის შენახვის შეცდომა",
  "Order Save Error": "შეკვეთის შენახვის შეცდომა",
  "Supplier Delete Error": "მომწოდებლის წაშლის შეცდომა",
  "Order Delete Error": "შეკვეთის წაშლის შეცდომა",
  "Delete Error": "წაშლის შეცდომა",
  "Authentication / Sync Error": "ავტორიზაციის / სინქრონიზაციის შეცდომა",
  ...
  "Legal Name": "იურიდიული დასახელება",
  "Legal/Registered Name (Company Name)": "იურიდიული დასახელება",
  ...
  "Supplier / Vendor Status": "სტატუსი",
  "Active": "აქტიური",
  ...
  "Contacts": "კონტაქტი",
  "Contact": "კონტაქტი",
  "Select contact...": "აირჩიეთ კონტაქტი...",
  ...
  "Director": "დირექტორი",
  "director": "დირექტორი / მფლობელი",
  "manager": "მენეჯერი",
  "purchasing_head": "შესყიდვების ჯგუფის ხელმძღვანელი",
  "Object Number": "ობიექტის ნომერი",
  "object_number": "ობიექტის ნომერი",
  "Cook": "მზარეული",
  "cook": "მზარეული",
  "Operator": "ოპერატორი",
  "operator": "ოპერატორი",
  ...
  "other": "სხვა თანამდებობა",
  "Other": "სხვა თანამდებობა",
  "active": "აქტიური",
  "inactive": "არააქტიური",
  "Inactive": "არააქტიური",
  "Admin": "ადმინი",
  "Purchasing Group Leader": "შესყიდვების ჯგუფის ხელმძღვანელი",
  ...
  "Supplier Comments": "მომწოდებლის კომენტარები",
  "Add to Order": "შეკვეთაში დამატება",
  "Added to Order": "დამატებულია შეკვეთაში",
  "Added": "დამატებულია",
  "No comments attached to this supplier": "მომწოდებელს არ აქვს მიმაგრებული კომენტარები",
  "This supplier does not have any saved notes yet.": "ამ მომწოდებელს ჯერ არ აქვს შენახული შენიშვნები.",
  "Comments attached to this supplier. Use the button to attach any comment to the order dispatch.": "მომწოდებელზე მიმაგრებული კომენტარები. გამოიყენეთ ღილაკი შეკვეთაში გადასატანად მძღოლებისთვის.",
  "Remove from order comments": "შეკვეთის კომენტარებიდან ამოშლა",
  "Add to order comments": "შეკვეთის კომენტარებში დამატება",
  "Already added to order comments": "უკვე დამატებულია შეკვეთის კომენტარებში",
  ...
  "Tanks to Bring": "ავზების წამოღება",
  "Tanks to Leave": "ავზების დატოვება",
  "No previous interactions logged for this supplier": "ამ მომწოდებლისთვის წინა ინტერაქციები არ არის.",
  ...
  "Supplier is required": "მომწოდებელი სავალდებულოა",
  "Comment is required": "კომენტარი სავალდებულოა",
  "Date is required": "თარიღი სავალდებულოა",
  "Responsible user is required": "პასუხისმგებელი პირი სავალდებულოა",
  ...
  "Actions": "ქმედებები",
  "SMS Logs": "SMS ლოგები",
  "Assign Driver": "ეკიპაჟის მინიჭება",
  "Assign Crew": "ეკიპაჟის მინიჭება",
  "Order": "შეკვეთა",
  ...
  "Searching": "იძებნება",
  "Clear": "გასუფთავება",
  "Clear time": "დროის გასუფთავება",
  "Doc Num": "დოკუმენტის კოდი",
  "Document Code": "დოკუმენტის კოდი",
  "Warehouse": "საწყობი",
  "Dispatch Date": "შეკვეთის თარიღი",
  "Order Date": "შეკვეთის თარიღი",
  "Planned Qty": "შეკვ. რაოდენობა(ლ)",
  "Planned": "შეკვ. რაოდენობა(ლ)",
  "Order Qty (L)": "შეკვ. რაოდენობა(ლ)",
  "Fact QTY": "ფაქტ. რაოდენობა(ლ)",
  "Fact Qty (L)": "ფაქტ. რაოდენობა(ლ)",
  "Dropoff Tanks": "შეკვ. დატოვება",
  "Dropoff": "შეკვ. დატოვება",
  "Order Dropoff": "შეკვ. დატოვება",
  "Fact Tank Dropoff": "ფაქტ. დატოვება",
  "Fact Dropoff": "ფაქტ. დატოვება",
  "Pickup Tanks": "შეკვ. გამოტანა",
  "Pickup": "შეკვ. გამოტანა",
  ...
  "Tanks Dropoff": "ავზების დატოვება",
  "Tanks Pickup": "ავზების წამოღება",
  ...
  "Operations Vehicle Crew": "ლოჯისტიკის ეკიპაჟი",
  ...
  "Select Assistant": "აირჩიეთ დამხმარე",
  ...
  "Last Deliveries Tracker": "ვადაგადაცილებული მომწოდებლები",
  ...
  "Last Deliveries": "ვადაგადაცილებული მომწოდებლები",
  "Days Overdue": "ვადაგადაცილებული დღეები",
  ...
  "Company Trade Name": "კომპანიის დასახელება",
  "Creation Timestamp": "შექმნის თარიღი",
  "Latest Comment": "კომენტარი",
  "Orders Report": "შეკვეთები",
  "Orders Ledger": "შეკვეთების რეესტრი",
  "Review orders list with company trade name, creation timestamp, and latest handover comment.": "შეკვეთების სია დეტალური ინფორმაციით, მისამართებითა და ლოჯისტიკური მონაცემებით.",
  "კომპანიის დასახელება": "კომპანიის დასახელება",
  "საწყობი": "საწყობი",
  "კონტაქტი": "კონტაქტი",
  "დოკუმენტის კოდი": "დოკუმენტის კოდი",
  "შეკვეთის გატანის თარიღი": "შეკვეთის გატანის თარიღი",
  "გეგმ. რაოდენობა(ლ)": "გეგმ. რაოდენობა(ლ)",
  "გამოტანა": "გამოტანა",
  "დატოვება": "დატოვება",
  "ფაქტ. რაოდენობა(ლ)": "ფაქტ. რაოდენობა(ლ)",
  "ფაქტ. გამოტანა": "ფაქტ. გამოტანა",
  "ფაქტ. დატოვება": "ფაქტ. დატოვება",
  "კომენტარი": "კომენტარი",
  ...
  "monitored suppliers": "ვადაგადაცილებული მომწოდებელი",
  "Calculating live overdue statuses...": "ვადაგადაცილებული მომწოდებლები იძებნება",
  "Select a Direction": "აირჩიეთ მიმართულება",
