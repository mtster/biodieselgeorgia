    ...
    <div className="animate-in fade-in duration-200 max-w-4xl" id="vendors-form-panel">
      ...
      <div className="-mt-4 md:-mt-6 mb-6">
        <div className="sticky -top-4 md:-top-6 z-20 bg-[#f8fafc]/95 backdrop-blur-md py-4 px-4 md:px-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 select-none text-left shadow-xs">
          <div>
            <h2 className="text-lg font-extrabold text-gray-800 font-sans tracking-tight">Supplier Details</h2>
            <p className="text-[10px] text-gray-400 mt-0.5 font-sans">Manage supplier information and contacts.</p>
          </div>
