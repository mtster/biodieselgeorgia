...
export default function OrderDeleteModal({ docNumber, onClose, onConfirm }: Props) {
      ...
      <div className="bg-white rounded-2xl max-w-sm w-full p-6 text-center space-y-4 shadow-xl border border-gray-100 animate-in zoom-in-95 duration-150">
        ...
        <div className="space-y-1.5 text-center">
          ...
          <p className="text-xs text-gray-450 leading-relaxed font-sans">
            Are you sure you want to delete order dispatch invoice <strong>"#{docNumber}"</strong>? This dispatch logistics sequence will be expunged.
          </p>
        </div>
